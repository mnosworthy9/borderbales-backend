...
import User, { UserRoles } from "src/models(nn)/user-model";
import { cookieProps, p as paths } from "@routes/secure/user-router";
...
describe("user-router", () => {
    ...
    const loginPath = `${userPath}${paths.login}`;
    const logoutPath = `${userPath}${paths.logout}`;
